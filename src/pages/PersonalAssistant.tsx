...
const nextSteps = [
  ...
  },
  {
    ...
    desc: 'Desktop or Documents works fine. Name it whatever you want: "AI Assistant," your business name, anything.',
  },
  {
    n: '4',
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-slate-900 tracking-tight leading-tight mb-6">
            Create an AI personal assistant that helps you get work done.
          </h1>
          ...
          <a
            ...
            download
            onClick={() => {
              window.dataLayer?.push({ event: 'cta_click', cta_text: 'Download the AI Personal Assistant Kit', cta_location: 'hero' })
              setDownloaded(true)
            }}
          ...
          >
            Download the AI Personal Assistant Kit
          </a>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed">You ask it something, it gives you an answer, and then you still have to go do the thing yourself. It's a thinking tool, not a working one. An AI personal assistant changes that.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-slate-50">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">What an AI personal assistant actually changes.</h2>
          <p className="text-slate-600 leading-relaxed text-lg mb-6">
            An AI personal assistant gives your AI both things it's missing: a context file that teaches it who you are, how you work, your clients, your tools, and your priorities. Plus connections to the systems you actually use.
          </p>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                n: '3',
                title: 'Create a folder on your computer.',
                desc: 'This is where your personal assistant will live. Desktop or Documents works fine. Name it whatever you want: "AI Assistant," your business name, anything.',
              },
              {
                n: '4',
              ...
              },
              {
                ...
                desc: 'Claude asks you questions about your work, your clients, your tools, your goals. It builds your personal assistant file by file as you go. No tech skills needed. Just talk.',
              },
            ].map(({ n, title, desc }) => (
      ...
      <section className="py-16 px-6 bg-blue-600">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <a
            href="/ONBOARDING.md"
            download
            onClick={() => window.dataLayer?.push({ event: 'cta_click', cta_text: 'Download the AI Personal Assistant Kit', cta_location: 'bottom' })}
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="border border-slate-200 rounded-xl p-6">
              ...
              <p className="text-slate-600 text-sm mb-5 leading-relaxed">I'll set up your personal assistant with you, connect your tools, and make sure it's working. $150/hr.</p>
              <a
